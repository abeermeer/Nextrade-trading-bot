...
export function ChartIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="m7 16 4-8 4 4 4-6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function KeyIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M10.85 12.15 19 4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18 5l2 2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15 8l2 2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function FlaskIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M9 3h6v5l4 8H5l4-8V3Z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M5 16c.7.6 1.7 1 3 1 2 0 3-1 4-1s2 1 4 1c1.3 0 2.3-.4 3-1" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function WalletIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M16 12h4v2h-4a2 2 0 0 1 0-4Z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function PositionIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export function TradeIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
